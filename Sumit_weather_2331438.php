...
mysqli_query($mysqli, "create database if not exists Sumit_weather");
...
$url = 'https://api.openweathermap.org/data/2.5/weather?q=Torrance&appid=dd0bb92d325265ceb8ccf893dd2b9e0d';
